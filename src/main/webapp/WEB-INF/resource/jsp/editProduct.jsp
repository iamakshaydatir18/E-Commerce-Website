		...
		<div class="col-lg-12 well">
			<div class="row">
				...
				<form:form method="post" action="${url}"
					modelAttribute="editProductObj" enctype="multipart/form-data">
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-6 form-group">
								<form:label path="productId">Product Id</form:label>
								<form:input type="text" placeholder="Enter ProductId.."
									class="form-control" path="productId" disabled="false"></form:input>
							</div>
							<div class="col-sm-6 form-group">
						...
						<form:label path="productImage">Product Image</form:label>
							<form:input type="file" path="productImage" required = "true"/>
						</div>  
